...
static const struct LevelUpMove sMoltresRegionalLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GUST),
    LEVEL_UP_MOVE( 1, MOVE_LEER),
...
static const struct LevelUpMove sSandyShocksLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(85, MOVE_PLASMA_BLAST),
    LEVEL_UP_END
};
static const struct LevelUpMove sSandyShocksPreEvoLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_WAVE),
    LEVEL_UP_MOVE( 1, MOVE_ELECTRIC_TERRAIN),
    LEVEL_UP_MOVE( 1, MOVE_SUNNY_DAY),
    LEVEL_UP_MOVE( 1, MOVE_THUNDER_SHOCK),
    ...
    LEVEL_UP_MOVE(63, MOVE_SCORCHING_SANDS),
    LEVEL_UP_MOVE(70, MOVE_PLASMA_BLAST),
    LEVEL_UP_END
};
