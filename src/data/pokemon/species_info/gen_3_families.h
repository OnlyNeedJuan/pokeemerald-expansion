...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_TINTED_LENS, ABILITY_NONE, ABILITY_UNBURDEN },
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .abilities = { ABILITY_RATTLED, ABILITY_NONE, ABILITY_PLUCKY },
    ...
    [SPECIES_BLAZIKEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STRIKER, ABILITY_NONE, ABILITY_PLUCKY },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_ZIGZAGOON_GALAR] =
    {
        ...
        .formSpeciesIdTable = sZigzagoonFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_OBSTAGOON}),
    },
    ...
    [SPECIES_SEEDOT] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_EARLY_BIRD, ABILITY_PLUCKY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SHIFTRY] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_WIND_RIDER, ABILITY_PLUCKY },
    #else
    ...
    [SPECIES_SWELLOW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_GUTS, ABILITY_GALE_WINGS, ABILITY_AERILATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WINGULL] =
    {
        ...
        .abilities = { ABILITY_KEEN_EYE, ABILITY_WIND_RIDER, ABILITY_RAIN_DISH },
    #else
    ...
    [SPECIES_PELIPPER] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FLYING),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_KEEN_EYE, ABILITY_GLUTTONY, ABILITY_RAIN_DISH },
    #else
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_RAIN_DISH },
    #endif
        .bodyColor = BODY_COLOR_YELLOW,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SURSKIT] =
    {
        ...
        .abilities = { ABILITY_RAIN_DISH, ABILITY_SWIFT_SWIM, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .baseAttack    = 60,
        .baseDefense   = 62,
        .baseSpeed     = P_UPDATED_STATS >= GEN_7 ? 103 : 60,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_WATER_BUBBLE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_GRASS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_LONG_REACH, ABILITY_POISON_HEAL, ABILITY_TECHNICIAN },
    #else
    ...
    [SPECIES_SKITTY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_DELCATTY}),
    },
    ...
    [SPECIES_SABLEYE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_NONE, ABILITY_PRANKSTER },
    #else
    ...
    [SPECIES_ELECTRIKE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_LIGHTNING_ROD, ABILITY_ARCING },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WAILMER] =
    {
        ...
        .abilities = { ABILITY_PRESSURE, ABILITY_OBLIVIOUS, ABILITY_HYDRATE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CAMERUPT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_STEAM_ENGINE, ABILITY_BERSERK, ABILITY_ANGER_POINT },
    #else
    ...
    [SPECIES_VIBRAVA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = TRAPINCH_FAMILY_EGG_GROUPS,
        .abilities = { ABILITY_LEVITATE, ABILITY_CACOPHONY, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_SWABLU] =
    {
        ...
        .abilities = { ABILITY_CLOUD_NINE, ABILITY_PIXILATE, ABILITY_FLUFFY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SEVIPER] =
    {
        ...
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_SHED_SKIN, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_SHUPPET] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_PRANKSTER, ABILITY_RESENTFUL, ABILITY_CURSED_BODY },
    #else
    ...
    [SPECIES_CHINGLING] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_SOUNDPROOF, ABILITY_WIND_RIDER },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SNORUNT] =
    {
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_ICE_BODY, ABILITY_INNER_FOCUS, ABILITY_REFRIGERATE },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 42, SPECIES_GLALIE}
                            #if P_GEN_4_CROSS_EVOS
                                ,{EVO_ITEM, ITEM_ICE_STONE, SPECIES_FROSLASS, CONDITIONS({IF_GENDER, MON_FEMALE})}
                            #endif
                            ),
    },
    ...
    [SPECIES_GLALIE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HEATPROOF, ABILITY_INTIMIDATE, ABILITY_REFRIGERATE },
    #else
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_NONE, ABILITY_MOODY },
    #endif
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_FROZEN_TOUCH, ABILITY_SNOW_WARNING, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_BELDUM] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_NONE, ABILITY_SLUSH_RUSH },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_LATIOS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_LEVITATE, ABILITY_NONE, ABILITY_ARMOR_TAIL },
        .bodyColor = BODY_COLOR_BLUE,
