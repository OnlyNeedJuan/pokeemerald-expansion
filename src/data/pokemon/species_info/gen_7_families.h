...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_GRUBBIN] =
    {
        ...
        .abilities = { ABILITY_SWARM, ABILITY_NONE, ABILITY_ANTICIPATION },
    ...
    [SPECIES_VIKAVOLT_TOTEM] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SURGE_SURFER, ABILITY_NONE, ABILITY_MOTOR_DRIVE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Vikavolt"),
        .cryId = CRY_VIKAVOLT,
        .natDexNum = NATIONAL_DEX_VIKAVOLT,
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_3),
        .abilities = { ABILITY_FROZEN_TOUCH, ABILITY_IRON_FIST, ABILITY_ANGER_POINT },
