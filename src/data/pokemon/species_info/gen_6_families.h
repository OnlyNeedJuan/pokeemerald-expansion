...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HEALER, ABILITY_SUPER_LUCK, ABILITY_AROMA_VEIL },
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .abilities = { ABILITY_NATURAL_CURE, ABILITY_RESENTFUL, ABILITY_HARVEST },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .abilities = { ABILITY_FROZEN_TOUCH, ABILITY_ICE_BODY, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_BLUE,
