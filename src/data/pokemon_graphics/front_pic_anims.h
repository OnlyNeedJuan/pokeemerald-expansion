...
static const union AnimCmd sAnim_MoltresRegional_1[] =
{
    ANIMCMD_FRAME(1, 3),
    ANIMCMD_FRAME(0, 3),
    ANIMCMD_FRAME(1, 3),
...
static const union AnimCmd sAnim_SandyShocksPreEvo_1[] =
{
    ANIMCMD_FRAME(0, 15),
    ANIMCMD_FRAME(1, 15),
    ANIMCMD_FRAME(0, 15),
...
SINGLE_ANIMATION(MoltresRegional);
#if P_GALARIAN_FORMS
...
SINGLE_ANIMATION(SandyShocksPreEvo);
#endif //P_FAMILY_SANDY_SHOCKS
#if P_FAMILY_IRON_TREADS
