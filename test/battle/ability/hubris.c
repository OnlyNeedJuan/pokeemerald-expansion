...
DOUBLE_BATTLE_TEST("Hubris raises Sp. Attack by one stage after directly causing a Pokemon to faint")
{
    u32 species = 0, abilityPopUp = 0;
    enum Ability ability = 0;
    PARAMETRIZE { species = SPECIES_GENGAR;            ability = ABILITY_HUBRIS;          abilityPopUp = ABILITY_HUBRIS; }
    ...
    GIVEN {
        ...
        if (species == SPECIES_GENGAR)
            MESSAGE("Gengar's Sp. Atk drastically rose!");
        else
...
DOUBLE_BATTLE_TEST("Hubris does not trigger if Pokemon faint to indirect damage or damage from other Pokemon")
{
    u32 species = 0, abilityPopUp = 0;
    enum Ability ability = 0;
    PARAMETRIZE { species = SPECIES_GENGAR;            ability = ABILITY_HUBRIS;          abilityPopUp = ABILITY_HUBRIS; }
    ...
    GIVEN {
        ...
        for (i = 0; i < 3; i++) {
            ...
            NONE_OF {
                ...
                MESSAGE("Gengar's Hubris raised its Sp. Atk!");
...
DOUBLE_BATTLE_TEST("Hubris does not increase damage done by the same move that causes another Pokemon to faint")
{
    s16 damage[2];
    u32 species = 0, abilityPopUp = 0;
    enum Ability ability = 0;
