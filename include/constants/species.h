...
#define CUSTOM_MONS_START SPECIES_MIMIKYU_TOTEM_BUSTED + 1
//Custom
...
#define SPECIES_CHARIZARD_DRAGONSTONE                   CUSTOM_MONS_START + 4

#define SPECIES_EGG SPECIES_CHARIZARD_DRAGONSTONE +1
