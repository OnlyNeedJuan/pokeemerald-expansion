...
#define CUSTOM_MONS_START SPECIES_URSHIFU_RAPID_STRIKE_STYLE_GIGANTAMAX + 1
//Custom

#define SPECIES_SANDY_SHOCKS_PRE_EVO                    CUSTOM_MONS_START + 1
#define SPECIES_MOLTRES_REGIONAL                        CUSTOM_MONS_START + 2
#define SPECIES_AZUTRICE                                CUSTOM_MONS_START + 3

#define SPECIES_EGG SPECIES_AZUTRICE +1
